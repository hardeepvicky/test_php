...
class CsvUtility
{
    ...
    public function find($fields = [], $conditions = [], $orders = null, $limit = null, $start_row_counter = 1)
    {
        ...
        if (($handle = fopen($this->file, 'r')) !== FALSE) {
            while (($row = fgetcsv($handle, 0, $this->delimeter)) !== FALSE) {
                ...
                if ($row_count < $start_row_counter) {
                    continue;
                }
                    ...
                    switch ($data_type) {
                        ...
                        case CsvDataType::TEXT:
                            switch($op)
                            {
                                ...
                                case "like":
                                    return strpos($v, $compare_v) !== false;
    ...
    public function deleteByRow($start_row, $end_row) {}
}
